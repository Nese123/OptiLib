...
4. **Price Estimation:** It utilizes the integrated `MolPrice` module to estimate or retrieve pricing for the candidate compounds.
...
To start the OptiDrug web application, run:
